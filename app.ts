...
/*
WHAT IS TYPESCRIPT?
- Superset of JavaScript (adds type safety)
- Catches errors before runtime
- Better IDE support (autocomplete, hints)
- Compiles to JavaScript (.ts → .js)
...
They tell TypeScript what properties an object should have
This prevents typos and wrong data types
*/

/**
* Generic API Response wrapper
* Matches the ApiResponse<T> class in Spring Boot
*
* @template T - Generic type parameter (can be any type)
* Example: ApiResponse<string>, ApiResponse<WelcomeResponse>
*/
interface ApiResponse<T> {
status: 'success' | 'error';
/*
Literal types: status can ONLY be 'success' or 'error'
TypeScript will error if you try to use any other value
This is stricter than: status: string
*/

message?: string;
/*
? means optional property
The property might not exist in the object
Without ?, TypeScript requires the property to always exist
*/

data?: T;
/*
T is a generic type parameter
It will be replaced with the actual type when used
Example: ApiResponse<WelcomeResponse> → data?: WelcomeResponse
*/
}

/**
* Welcome Message Response
* Matches WelcomeResponse.java in Spring Boot
*/
interface WelcomeResponse {
welcomeMessage: string;
/*
string type means this property must be text
TypeScript will error if you try to assign a number, boolean, etc.
*/
}

/**
* Greeting Response with user's name
* Matches GreetingResponse.java in Spring Boot
*/
interface GreetingResponse {
greeting: string;   // The personalized greeting text
name: string;       // The user's name that was greeted
}
...
async function loadWelcomeMessage(): Promise<void> {
    ...
    */
    ...
    const response: ApiResponse<WelcomeResponse> = await fetchFromAPI<WelcomeResponse>('/hello');
    /*
